...
const VideoTitle = ({title,description}) =>{
    ...
    return (
        <div className=" p-2 bg-gradient-to-r from-black w-screen aspect-video text-white absolute top-0 z-10">
            <div className="absolute top-[30%] left-[8%]"><h1 className="font-bold text-4xl">{title}</h1>
